...
CREATE TABLE `airports` (
	...
	`code` VARCHAR(10)  COLLATE 'utf8_general_ci',
	`city_id` INTEGER(10) UNSIGNED NOT NULL,
	`state_id` INTEGER(10) UNSIGNED NOT NULL,
	...
	FOREIGN KEY fk_state_id (`state_id`) REFERENCES states(`id`)
);
SQL;
$pdo->exec($sql);